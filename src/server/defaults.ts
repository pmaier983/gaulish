...
export const DEFAULT_MAP: Omit<Tile, "id">[] = [
  ...
  { x: 3, y: 0, type: "OCEAN", xyTileId: "3:0" },
  { x: 4, y: 0, type: "OCEAN", xyTileId: "4:0" },
  { x: 5, y: 0, type: "OCEAN", xyTileId: "5:0" },
  ...
  { x: 3, y: 1, type: "OCEAN", xyTileId: "3:1" },
  { x: 4, y: 1, type: "OCEAN", xyTileId: "4:1" },
  { x: 5, y: 1, type: "OCEAN", xyTileId: "5:1" },
  { x: 6, y: 1, type: "OCEAN", xyTileId: "6:1" },
  { x: 0, y: 2, type: "GRASSLAND", xyTileId: "0:2" },
  { x: 1, y: 2, type: "GRASSLAND", xyTileId: "1:2" },
  { x: 2, y: 2, type: "GRASSLAND", xyTileId: "2:2" },
  { x: 3, y: 2, type: "OCEAN", xyTileId: "3:2" },
  { x: 4, y: 2, type: "MOUNTAIN", xyTileId: "4:2" },
  { x: 5, y: 2, type: "OCEAN", xyTileId: "5:2" },
  { x: 6, y: 2, type: "OCEAN", xyTileId: "6:2" },
  { x: 0, y: 3, type: "OCEAN", xyTileId: "0:3" },
  { x: 1, y: 3, type: "GRASSLAND", xyTileId: "1:3" },
  { x: 2, y: 3, type: "OCEAN", xyTileId: "2:3" },
  { x: 3, y: 3, type: "OCEAN", xyTileId: "3:3" },
  { x: 4, y: 3, type: "MOUNTAIN", xyTileId: "4:3" },
  { x: 5, y: 3, type: "OCEAN", xyTileId: "5:3" },
  { x: 6, y: 3, type: "OCEAN", xyTileId: "6:3" },
  { x: 0, y: 4, type: "OCEAN", xyTileId: "0:4" },
  { x: 1, y: 4, type: "OCEAN", xyTileId: "1:4" },
  { x: 2, y: 4, type: "OCEAN", xyTileId: "2:4" },
  { x: 3, y: 4, type: "MOUNTAIN", xyTileId: "3:4" },
  { x: 4, y: 4, type: "OCEAN", xyTileId: "4:4" },
  { x: 5, y: 4, type: "OCEAN", xyTileId: "5:4" },
  { x: 6, y: 4, type: "GRASSLAND", xyTileId: "6:4" },
  { x: 0, y: 5, type: "OCEAN", xyTileId: "0:5" },
  { x: 1, y: 5, type: "GRASSLAND", xyTileId: "1:5" },
  { x: 2, y: 5, type: "OCEAN", xyTileId: "2:5" },
  { x: 3, y: 5, type: "OCEAN", xyTileId: "3:5" },
  { x: 4, y: 5, type: "OCEAN", xyTileId: "4:5" },
  { x: 5, y: 5, type: "GRASSLAND", xyTileId: "5:5" },
  { x: 6, y: 5, type: "FOREST", xyTileId: "6:5" },
  { x: 0, y: 6, type: "OCEAN", xyTileId: "0:6" },
  { x: 1, y: 6, type: "OCEAN", xyTileId: "1:6" },
  { x: 2, y: 6, type: "OCEAN", xyTileId: "2:6" },
  { x: 3, y: 6, type: "OCEAN", xyTileId: "3:6" },
  { x: 4, y: 6, type: "OCEAN", xyTileId: "4:6" },
  { x: 5, y: 6, type: "OCEAN", xyTileId: "5:6" },
  { x: 6, y: 6, type: "OCEAN", xyTileId: "6:6" },
]
